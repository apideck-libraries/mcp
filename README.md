...
```bash
claude mcp add --transport http apideck https://mcp-native.apideck.dev/mcp \
...
```json
{
  "mcpServers": {
    "apideck": {
      "url": "https://mcp-native.apideck.dev/mcp",
      "headers": {
...
```
https://mcp-native.apideck.dev/mcp
```
...
```json
{
  "mcpServers": {
    "apideck": {
      "command": "node",
      "args": ["dist/bin/mcp-native.js", "--mode", "dynamic", "--scope", "read"],
...
APIDECK_API_KEY=... APIDECK_CONSUMER_ID=... APIDECK_APP_ID=... node dist/bin/mcp-native.js start

# Static mode (all 330 tools)
APIDECK_API_KEY=... node dist/bin/mcp-native.js start --mode static

# Code mode
APIDECK_API_KEY=... node dist/bin/mcp-native.js start --mode code

# Read-only
APIDECK_API_KEY=... node dist/bin/mcp-native.js start --scope read
```
...
mcp = MCPServerStdio(name="apideck", params={
    "command": "node",
    "args": ["dist/bin/mcp-native.js", "start", "--mode", "dynamic"],
    "env": {
        "APIDECK_API_KEY": "...",
        "APIDECK_CONSUMER_ID": "...",
        "APIDECK_APP_ID": "..."
