...
export const ProxyDeleteProxyGlobals$zodSchema = z.object({
...
export const ProxyDeleteProxyRequest$zodSchema = z.object({
    xApideckAppId: z.string().describe("The ID of your Unify application")
        .optional(),
    xApideckConsumerId: z.string().describe("ID of the consumer which you want to get or push data from").optional(),
...
export const ProxyDeleteProxyResponseResult$zodSchema = z.union([
...
export const ProxyDeleteProxyResponse$zodSchema = z.object({
...
//# sourceMappingURL=proxydeleteproxyop.js.map