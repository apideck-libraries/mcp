...
export const ProxyGetProxyGlobals$zodSchema = z
    .object({
...
export const ProxyGetProxyRequest$zodSchema = z
    .object({
    xApideckAppId: z.string().describe("The ID of your Unify application")
        .optional(),
    xApideckConsumerId: z.string().describe("ID of the consumer which you want to get or push data from").optional(),
...
export const ProxyGetProxyResponseResult$zodSchema = z.union([
...
export const ProxyGetProxyResponse$zodSchema = z.object({
...
//# sourceMappingURL=proxygetproxyop.js.map