...
export const ProxyOptionsProxyGlobals$zodSchema = z.object({
...
export const ProxyOptionsProxyRequest$zodSchema = z.object({
    xApideckAppId: z.string().describe("The ID of your Unify application")
        .optional(),
    xApideckConsumerId: z.string().describe("ID of the consumer which you want to get or push data from").optional(),
...
export const ProxyOptionsProxyResponse$zodSchema = z.object({
...
//# sourceMappingURL=proxyoptionsproxyop.js.map