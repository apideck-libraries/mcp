...
export var PutAcceptEnum;
(function (PutAcceptEnum) {
    PutAcceptEnum["applicationJsonAccept"] = "application/json";
    PutAcceptEnum["textCsvAccept"] = "text/csv";
    PutAcceptEnum["textPlainAccept"] = "text/plain";
    PutAcceptEnum["applicationOctetStreamAccept"] = "application/octet-stream";
    PutAcceptEnum["applicationPdfAccept"] = "application/pdf";
    PutAcceptEnum["applicationXmlAccept"] = "application/xml";
    PutAcceptEnum["textHtmlAccept"] = "text/html";
})(PutAcceptEnum || (PutAcceptEnum = {}));
/**
 * PUT
 *
 * @remarks
 ...
 */
export function proxyPut(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ProxyPutProxyRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
