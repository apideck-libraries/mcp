...
import { ProxyPutProxyRequest } from "../models/proxyputproxyop.js";
 ...
 */
export declare function proxyPut(client$: ApideckMcpCore, request: ProxyPutProxyRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
