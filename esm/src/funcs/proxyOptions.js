...
export var OptionsAcceptEnum;
(function (OptionsAcceptEnum) {
    OptionsAcceptEnum["applicationJsonAccept"] = "application/json";
    OptionsAcceptEnum["textCsvAccept"] = "text/csv";
    OptionsAcceptEnum["textPlainAccept"] = "text/plain";
    OptionsAcceptEnum["applicationOctetStreamAccept"] = "application/octet-stream";
    OptionsAcceptEnum["applicationPdfAccept"] = "application/pdf";
    OptionsAcceptEnum["applicationXmlAccept"] = "application/xml";
    OptionsAcceptEnum["textHtmlAccept"] = "text/html";
})(OptionsAcceptEnum || (OptionsAcceptEnum = {}));
/**
 * OPTIONS
 *
 * @remarks
 ...
 */
export function proxyOptions(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ProxyOptionsProxyRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
