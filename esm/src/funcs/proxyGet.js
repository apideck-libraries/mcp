...
export var GetAcceptEnum;
(function (GetAcceptEnum) {
    GetAcceptEnum["applicationJsonAccept"] = "application/json";
    GetAcceptEnum["textCsvAccept"] = "text/csv";
    GetAcceptEnum["textPlainAccept"] = "text/plain";
    GetAcceptEnum["applicationOctetStreamAccept"] = "application/octet-stream";
    GetAcceptEnum["applicationPdfAccept"] = "application/pdf";
    GetAcceptEnum["applicationXmlAccept"] = "application/xml";
    GetAcceptEnum["textHtmlAccept"] = "text/html";
})(GetAcceptEnum || (GetAcceptEnum = {}));
/**
 * GET
 *
 * @remarks
 ...
 */
export function proxyGet(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ProxyGetProxyRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
