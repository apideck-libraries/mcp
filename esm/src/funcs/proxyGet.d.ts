...
import { ProxyGetProxyRequest } from "../models/proxygetproxyop.js";
 ...
 */
export declare function proxyGet(client$: ApideckMcpCore, request: ProxyGetProxyRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
