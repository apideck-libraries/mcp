...
export var PatchAcceptEnum;
(function (PatchAcceptEnum) {
    PatchAcceptEnum["applicationJsonAccept"] = "application/json";
    PatchAcceptEnum["textCsvAccept"] = "text/csv";
    PatchAcceptEnum["textPlainAccept"] = "text/plain";
    PatchAcceptEnum["applicationOctetStreamAccept"] = "application/octet-stream";
    PatchAcceptEnum["applicationPdfAccept"] = "application/pdf";
    PatchAcceptEnum["applicationXmlAccept"] = "application/xml";
    PatchAcceptEnum["textHtmlAccept"] = "text/html";
})(PatchAcceptEnum || (PatchAcceptEnum = {}));
/**
 * PATCH
 *
 * @remarks
 ...
 */
export function proxyPatch(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ProxyPatchProxyRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
