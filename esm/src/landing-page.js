...
export function landingPageHTML(origin) {
    ...
    const mcpConfig = {
        ...
        "env": {
            ...
            "CONSUMER_ID": "YOUR_VALUE_HERE",
            "APP_ID": "YOUR_VALUE_HERE",
        },
    };
    const codexConfig = `[mcp_servers.ApideckMcp]
url = "${o}/sse"
http_headers = { "api-key" = "YOUR_API_KEY", "consumer-id" = "YOUR_CONSUMER_ID", "app-id" = "YOUR_APP_ID" }`;
    return `
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>@apideck/mcp MCP</title>
    <meta name="description" content="Install @apideck/mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@apideck/mcp - MCP Server">
    <meta property="og:description" content="Install @apideck/mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@apideck/mcp - MCP Server">
    <meta property="twitter:description" content="Install @apideck/mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@apideck/mcp</div>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=ApideckMcp&config=">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add --transport sse ApideckMcp undefined/sse</code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/apideck-libraries/mcp/releases/download/v0.1.13/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add --transport sse ApideckMcp undefined/sse</code>
        </div>
      </div>
    </div>
