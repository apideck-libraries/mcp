...
export const serveCommand = buildCommand({
    ...
    parameters: {
        flags: {
            ...
            "disable-static-auth": {
                kind: "boolean",
                brief: "Disable static authentication, allowing credentials to be passed via request headers only",
                default: false,
            },
            tool: {
                kind: "parsed",
            ...
            "consumer-id": {
                kind: "parsed",
                brief: "Allows setting the consumerId parameter for all supported operations",
                optional: true,
                parse: (value) => {
                    return z.string().parse(value);
                },
            ...
            "app-id": {
                kind: "parsed",
                brief: "Allows setting the appId parameter for all supported operations",
                optional: true,
                parse: (value) => {
                    return z.string().parse(value);
                },
