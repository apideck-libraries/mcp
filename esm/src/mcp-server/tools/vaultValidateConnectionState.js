...
export const tool$vaultValidateConnectionState = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await vaultValidateConnectionState(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
