...
import {
  ...
  VaultValidateConnectionStateRequest$zodSchema,
} from "../models/vaultvalidateconnectionstateop.js";
...
export function vaultValidateConnectionState(
  ...
  request: VaultValidateConnectionStateRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VaultValidateConnectionStateRequest$zodSchema.parse(value$),
