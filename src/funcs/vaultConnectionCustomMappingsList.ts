...
import {
  ...
  VaultConnectionCustomMappingsAllRequest$zodSchema,
} from "../models/vaultconnectioncustommappingsallop.js";
...
export function vaultConnectionCustomMappingsList(
  ...
  request: VaultConnectionCustomMappingsAllRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VaultConnectionCustomMappingsAllRequest$zodSchema.parse(value$),
