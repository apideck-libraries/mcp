...
import {
  ...
  ConnectorApiResourceCoverageOneRequest$zodSchema,
} from "../models/connectorapiresourcecoverageoneop.js";
...
export function connectorApiResourceCoverageGet(
  ...
  request: ConnectorApiResourceCoverageOneRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ConnectorApiResourceCoverageOneRequest$zodSchema.parse(value$),
