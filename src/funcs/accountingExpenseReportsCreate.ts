...
import {
  ...
  AccountingExpenseReportsAddRequest$zodSchema,
} from "../models/accountingexpensereportsaddop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AccountingExpenseReportsAddRequest$zodSchema.parse(value$),
