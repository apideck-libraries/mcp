...
import {
  ...
  VaultCustomFieldsAllRequest$zodSchema,
} from "../models/vaultcustomfieldsallop.js";
...
export function vaultCustomFieldsList(
  ...
  request: VaultCustomFieldsAllRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VaultCustomFieldsAllRequest$zodSchema.parse(value$),
