...
import {
  ...
  AccountingAttachmentsOneRequest$zodSchema,
} from "../models/accountingattachmentsoneop.js";
...
export function accountingAttachmentsGet(
  ...
  request: AccountingAttachmentsOneRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AccountingAttachmentsOneRequest$zodSchema.parse(value$),
