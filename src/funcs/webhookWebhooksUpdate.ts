...
import {
  ...
  WebhookWebhooksUpdateRequest$zodSchema,
} from "../models/webhookwebhooksupdateop.js";
...
export function webhookWebhooksUpdate(
  ...
  request: WebhookWebhooksUpdateRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => WebhookWebhooksUpdateRequest$zodSchema.parse(value$),
