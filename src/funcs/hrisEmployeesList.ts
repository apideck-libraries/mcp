...
import {
  ...
  HrisEmployeesAllRequest$zodSchema,
} from "../models/hrisemployeesallop.js";
...
export function hrisEmployeesList(
  ...
  request?: HrisEmployeesAllRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HrisEmployeesAllRequest$zodSchema.optional().parse(value$),
