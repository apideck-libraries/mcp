...
import {
  FileStorageUploadSessionsAddOpServerList,
  FileStorageUploadSessionsAddRequest,
  FileStorageUploadSessionsAddRequest$zodSchema,
} from "../models/filestorageuploadsessionsaddop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FileStorageUploadSessionsAddRequest$zodSchema.parse(value$),
