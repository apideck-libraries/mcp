...
import {
  ...
  VaultCreateCallbackStateRequest$zodSchema,
} from "../models/vaultcreatecallbackstateop.js";
...
export function vaultCreateCallbackState(
  ...
  request: VaultCreateCallbackStateRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VaultCreateCallbackStateRequest$zodSchema.parse(value$),
