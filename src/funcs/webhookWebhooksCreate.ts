...
import {
  ...
  WebhookWebhooksAddRequest$zodSchema,
} from "../models/webhookwebhooksaddop.js";
...
export function webhookWebhooksCreate(
  ...
  request: WebhookWebhooksAddRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => WebhookWebhooksAddRequest$zodSchema.parse(value$),
