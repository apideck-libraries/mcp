...
import {
  ...
  VaultCustomMappingsAllRequest$zodSchema,
} from "../models/vaultcustommappingsallop.js";
...
export function vaultCustomMappingsList(
  ...
  request: VaultCustomMappingsAllRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VaultCustomMappingsAllRequest$zodSchema.parse(value$),
