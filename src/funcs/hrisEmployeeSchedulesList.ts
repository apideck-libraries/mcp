...
import {
  ...
  HrisEmployeeSchedulesAllRequest$zodSchema,
} from "../models/hrisemployeeschedulesallop.js";
...
export function hrisEmployeeSchedulesList(
  ...
  request: HrisEmployeeSchedulesAllRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => HrisEmployeeSchedulesAllRequest$zodSchema.parse(value$),
