...
import {
  ...
  AccountingAttachmentsDownloadRequest$zodSchema,
} from "../models/accountingattachmentsdownloadop.js";
...
export function accountingAttachmentsDownload(
  ...
  request: AccountingAttachmentsDownloadRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AccountingAttachmentsDownloadRequest$zodSchema.parse(value$),
