...
import {
  ...
  ProxyOptionsProxyRequest$zodSchema,
} from "../models/proxyoptionsproxyop.js";
...
export function proxyOptions(
  ...
  request: ProxyOptionsProxyRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ProxyOptionsProxyRequest$zodSchema.parse(value$),
