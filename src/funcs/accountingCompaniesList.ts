...
import {
  ...
  AccountingCompaniesAllRequest$zodSchema,
} from "../models/accountingcompaniesallop.js";
...
export function accountingCompaniesList(
  ...
  request?: AccountingCompaniesAllRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      AccountingCompaniesAllRequest$zodSchema.optional().parse(value$),
