...
import {
  FileStorageUploadSessionsUploadOpServerList,
  FileStorageUploadSessionsUploadRequest,
  FileStorageUploadSessionsUploadRequest$zodSchema,
} from "../models/filestorageuploadsessionsuploadop.js";
...
export function fileStorageUploadSessionsUpload(
  ...
  request: FileStorageUploadSessionsUploadRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => FileStorageUploadSessionsUploadRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/file-storage/upload-sessions/{id}")(
    pathParams$,
  );
