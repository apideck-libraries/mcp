...
export const Opportunity$zodSchema: z.ZodType<Opportunity> = z.object({
  ...
  expected_revenue: z.number().nullable().optional().describe(
    "The expected revenue from the opportunity",
  ),
  id: z.string().optional().describe(
    "A unique identifier for the opportunity.",
  ),
  interaction_count: z.number().nullable().optional().describe(
    "The number of interactions with the opportunity.",
  ),
  last_activity_at: z.string().nullable().optional().describe(
