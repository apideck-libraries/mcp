...
export const ConnectorResource$zodSchema: z.ZodType<ConnectorResource> = z
  .object({
    custom_fields_supported: z.boolean().optional().describe(
    ...
    downstream_unsupported_operations: z.array(z.string()).optional().describe(
