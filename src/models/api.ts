...
export const Resource$zodSchema: z.ZodType<Resource> = z.object({
  excluded_from_coverage: z.boolean().optional().describe(
...
export const Api$zodSchema: z.ZodType<Api> = z.object({
  api_reference_url: z.string().optional().describe(
  ...
  postman_collection_id: z.string().nullable().optional().describe(
  ...
  spec_url: z.string().optional().describe(
  ...
  type: ApiType$zodSchema.optional().describe(
    "Indicates whether the API is a Unified API. If unified_api is false, the API is a Platform API.",
  ),
});
